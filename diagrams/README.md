...
| DIA-003 | `03-erd.puml` | ERD | Cases / Messages / Analyses / Solutions / ConfidenceMatches / AutoAnswerLogs schema |
...
| DIA-007 | `07-confidence-suggestion-seq.puml` | sequence | WF-004 — confidence match → guarded auto-answer → Teams audit notify / confirm-reinforce |
